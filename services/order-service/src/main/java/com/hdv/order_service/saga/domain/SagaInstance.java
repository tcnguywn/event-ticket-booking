...
@Table(name = "saga_instances", indexes = {
        @Index(name = "idx_saga_status_retry_order", columnList = "status, next_retry_at"),
        @Index(name = "idx_saga_correlation_order", columnList = "correlation_id"),
        @Index(name = "idx_saga_business_order", columnList = "business_id")
})
@Getter
@Setter
@NoArgsConstructor
