...
public interface OutboxRepository extends JpaRepository<Outbox, UUID> {
    ...
    @Modifying
    @Query("UPDATE Outbox o SET o.status = com.hdv.payment_service.enums.OutboxStatus.SENT, " +
    ...
    @Modifying
    @Query("UPDATE Outbox o SET o.status = com.hdv.payment_service.enums.OutboxStatus.PROCESSING, " +
    ...
    @Modifying
    @Query("DELETE FROM Outbox o WHERE o.status = com.hdv.payment_service.enums.OutboxStatus.SENT AND o.processedAt < :cutoff")
    int deleteOldProcessedEvents(@Param("cutoff") LocalDateTime cutoff);
}
